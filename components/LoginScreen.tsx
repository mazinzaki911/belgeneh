...
import { AtSymbolIcon, LockClosedIcon } from '../constants';
  ...
  return (
    ...
    >
      ...
      <p className="text-center text-sm text-neutral-500 dark:text-neutral-400">
        {t('login.noAccount')}{' '}
        <button onClick={onSignUpClick} className="font-semibold text-primary dark:text-primary-dark hover:underline focus:outline-none">
          {t('login.signUpLink')}
        </button>
      </p>
    </AuthLayout>
