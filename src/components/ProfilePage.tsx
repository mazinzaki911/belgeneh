...
export const ProfilePage: React.FC<ProfilePageProps> = ({ currentUser }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      {/* Profile Header */}
      <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-lg p-4 sm:p-6 flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-lg p-4 sm:p-6 flex items-center gap-4">
